...
- [6.2 Kernel Hardening Fragment](./KERNEL_HARDENING_FRAGMENT.md)
- [6.3 Users Fragment](./USERS_FRAGMENT.md)
...
├── 15-kernel.yaml.tpl       # Kernel hardening (sysctl)
...
|-------|----------|---------|
| Kernel | [6.2 Kernel Hardening](./KERNEL_HARDENING_FRAGMENT.md) | sysctl security settings |
