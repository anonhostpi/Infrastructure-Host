# Phase 2: Package Upgrade Fragment

**Book:** 2
**Path:** book-2-cloud/pkg-upgrade/
...
- **Depends on:** Book 0 (SDKs), Book 1 base, all other package fragments
- **Depended on by:** None - this runs last
...
- build_order: 999 ensures this runs LAST after all other packages installed
- Template-only fragment (runs apt upgrade)
