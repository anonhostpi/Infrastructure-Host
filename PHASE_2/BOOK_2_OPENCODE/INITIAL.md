# Phase 2: OpenCode Fragment

**Book:** 2
**Path:** book-2-cloud/opencode/
...
- `opencode.config.yaml` / `opencode.config.yaml.example`

Changes needed:

- [ ] Rename `opencode.config.yaml` to `production.yaml`
- [ ] Rename `opencode.config.yaml.example` to `production.yaml.example`
