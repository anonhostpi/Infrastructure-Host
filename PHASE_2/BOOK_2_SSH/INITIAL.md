# Phase 2: SSH Fragment

**Book:** 2
**Path:** book-2-cloud/ssh/
...
- **Depended on by:** None directly - SSH is typically last of required fragments
...
- SSH is `iso_required: true` - bare metal needs SSH for headless access
- Minimal fragment - no config files, no scripts
- SSH config may reference users fragment (authorized_keys)
