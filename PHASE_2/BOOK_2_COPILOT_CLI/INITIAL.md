# Phase 2: Copilot CLI Fragment

**Book:** 2
**Path:** book-2-cloud/copilot-cli/
...
- `copilot_cli.config.yaml` / `copilot_cli.config.yaml.example`

Changes needed:

- [ ] Rename `copilot_cli.config.yaml` to `production.yaml`
- [ ] Rename `copilot_cli.config.yaml.example` to `production.yaml.example`
...
- Config may contain API keys/tokens - ensure gitignored
