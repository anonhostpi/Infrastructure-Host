...
- [x] [Overview](./docs/CLOUD_INIT_CONFIGURATION/OVERVIEW.md)
  ...
  - [x] [6.9 Security Monitoring Fragment](./docs/CLOUD_INIT_CONFIGURATION/SECURITY_MONITORING_FRAGMENT.md)
  ...
  - [x] [6.12 Claude Code Fragment](./docs/CLOUD_INIT_CONFIGURATION/CLAUDE_CODE_FRAGMENT.md)
  - [x] [6.13 Copilot CLI Fragment](./docs/CLOUD_INIT_CONFIGURATION/COPILOT_CLI_FRAGMENT.md)
  - [x] [6.14 OpenCode Fragment](./docs/CLOUD_INIT_CONFIGURATION/OPENCODE_FRAGMENT.md)
...
- [ ] [Overview](./docs/TESTING_AND_VALIDATION/OVERVIEW.md)
  - [x] [7.1 Cloud-init Testing](./docs/TESTING_AND_VALIDATION/CLOUD_INIT_TESTING.md)
    - [x] Tests written
    - [x] All tests pass
