...
| Test | Fragment | Location |
|------|----------|----------|
| [TEST_6.1](./TEST_6.1_NETWORK.md) | Network Configuration | `book-1-foundation/network/` |
| [TEST_6.2](./TEST_6.2_KERNEL_HARDENING.md) | Kernel Hardening | `book-1-foundation/kernel/` |
| [TEST_6.3](./TEST_6.3_USERS.md) | Users Configuration | `book-2-cloud/users/` |
| [TEST_6.4](./TEST_6.4_SSH_HARDENING.md) | SSH Hardening | `book-2-cloud/ssh/` |
| [TEST_6.5](./TEST_6.5_UFW.md) | UFW Firewall | `book-2-cloud/ufw/` |
| [TEST_6.6](./TEST_6.6_SYSTEM_SETTINGS.md) | System Settings | `book-2-cloud/system/` |
| [TEST_6.7](./TEST_6.7_MSMTP.md) | MSMTP Mail | `book-2-cloud/msmtp/` |
| [TEST_6.8](./TEST_6.8_PACKAGE_SECURITY.md) | Package Security | `book-2-cloud/packages/` |
| [TEST_6.9](./TEST_6.9_SECURITY_MONITORING.md) | Security Monitoring | `book-2-cloud/security-mon/` |
| [TEST_6.10](./TEST_6.10_VIRTUALIZATION.md) | Virtualization | `book-2-cloud/virtualization/` |
| [TEST_6.11](./TEST_6.11_COCKPIT.md) | Cockpit | `book-2-cloud/cockpit/` |
| [TEST_6.12](./TEST_6.12_CLAUDE_CODE.md) | Claude Code | `book-2-cloud/ai-cli/` |
| [TEST_6.13](./TEST_6.13_COPILOT_CLI.md) | Copilot CLI | `book-2-cloud/ai-cli/` |
| [TEST_6.14](./TEST_6.14_OPENCODE.md) | OpenCode | `book-2-cloud/ai-cli/` |
| [TEST_6.15](./TEST_6.15_UI_TOUCHES.md) | UI Touches | `book-2-cloud/ui/` |
